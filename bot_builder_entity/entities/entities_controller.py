...
class EntitiesController:
    ...
    @Post('/')
    @validate_token
    def create(self, request: Request, auth_service_stub: AuthServiceStubDepend, create_entity_dto: CreateEntityDto):
        user_id = request.__dict__['user'].id
        return self.entities_service.create(create_entity_dto, user_id)
    
    @Put('/')
    @validate_token
    def update(self, request: Request, auth_service_stub: AuthServiceStubDepend, update_entity_dto: UpdateEntityDto):
        return self.entities_service.update(update_entity_dto)
    
    @Delete('/')
    @validate_token
    def delete(self, request: Request, auth_service_stub: AuthServiceStubDepend, delete_entity_dto: DeleteEntityDto):
